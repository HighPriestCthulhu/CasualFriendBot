This is bot that grabs messages from reddit, then throws them into a matchmaking algorithm to pair the message senders with similar people based on their post history.
